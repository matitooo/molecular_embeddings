...
from trimnet_utils import scaffold_randomized_spliting, onehot_encoding_unk
from trimnet_utils import onehot_encoding, split_multi_label_containNan
...
def load_dataset_random_nan(path, dataset, seed, tasks=None):
    ...
    if os.path.isfile(save_path):
        trn, val, test = torch.load(save_path,weights_only = False)
        return trn, val, test
